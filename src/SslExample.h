...
namespace std
{
    template <> struct is_error_condition_enum<nds::detail::SslErrorConditional> : public true_type {};
    template <> struct is_error_code_enum<nds::detail::SslError> : public true_type {};
} // namespace std
